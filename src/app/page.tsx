    ...
    <div className="bg-slate-50">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              <div className="mb-2 flex gap-0.5">
                <StarIcon className="size-5 fill-green-600 text-green-600" />
                <StarIcon className="size-5 fill-green-600 text-green-600" />
                <StarIcon className="size-5 fill-green-600 text-green-600" />
                <StarIcon className="size-5 fill-green-600 text-green-600" />
                <StarIcon className="size-5 fill-green-600 text-green-600" />
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  case for two and a half months and{" "}
                  <span className="bg-slate-600 p-0.5 text-white">the image is super clear</span>,
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  some heavy scratchmarks on all my last phone cases. This one, besides a barely
                  noticeable scratch on the corner, looks{" "}
                  <span className="bg-slate-600 p-0.5 text-white">brand new</span> after about half
                  a year. I love it. &quot;
                </p>
              </div>
              <div className="mt-2 flex gap-4">
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <div className="rounded-md border-green-600 py-6 md:border-4">
            <div className="mx-auto max-w-6xl px-6 lg:px-8">
              <div className="sm relative flex grid-cols-2 flex-col items-center gap-40 md:grid">
                <Image
                  src="/arrow.png"
                  alt="arrow"
            ...
            <ul className="mx-auto mt-12 w-fit max-w-prose space-y-2 sm:text-lg">
              ...
              <li className="w-fit">
                <Check className="mr-1.5 inline size-5 text-green-600" />5 year print warranty
              </li>
              <div>
                <Link
